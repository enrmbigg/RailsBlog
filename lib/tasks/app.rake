namespace :app do
  ...
  task populate: :environment do
    [ { title: "Awesomeness comes as standard.",
        ...
        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
          ...
          culpa qui officia deserunt mollit anim id est laborum.",author: 'Bob',
          author_id: 1 },
      { title: "Here comes Vader!",
        ...
        reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla 
        pariatur. Excepteur sint occaecat cupidatat non proident, sunt in 
        culpa qui officia deserunt mollit anim id est laborum.",author: 'Joe',
        author_id: 2 }
    ].each do |attributes|
  ...
  task populate: :environment do
    [ { email: "admin@example.com", password: "test" },
      { email: "jamie@example.com", password: "test" }
    ].each do |attributes|
